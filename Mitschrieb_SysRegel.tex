...
\begin{description}
\item[Idee] Aus dem Sollwert und der fortlaufenden Beobachtung des dynamischen Systems (``Strecke'') wird eine geeignete Änderung des Systems (``Stellgröße'') bestimmt, die dazu führt, das der Ausgangswert des Systems (``Regrelgröße'') dem Sollwert folgt. Dies geschiet auch bei Störeinwirkung.
\end{description}

\subsection{Reglerentwurd im Bildbereich}
\begin{figure}[H]
  \centering
