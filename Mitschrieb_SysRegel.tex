...
\hline
  \end{array}
\end{align*}
\textbf{HIER FEHLT MAL WIEDER WAS}
\begin{itemize}
...
\textbf{Falls nicht in der VL gemacht, hier aufstellung der Ortskurve theoretisch erläutern!}
